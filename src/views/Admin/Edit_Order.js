...
//package info
  ...
  const [shipmentstatus, setShipmentStatus] = useState(JSON.parse(shipmentdatas.status))
...
let val=option.target.value;
  if(!shipmentstatus.indexOf(val) > -1){
  setShipmentStatus([...shipmentstatus,timelineData[val]])
  }
        ...
        <CardHeader p="12px 5px" mb="12px">
          ...
          Shipment Status :
                 ...
                 <Select
                  ...
                  size="lg"
                  value={shipmentstatus.length-1}
                  onChange={handleStatus}
                >
                  {console.log(shipmentstatus)}
          {(!shipmentstatus[0] || shipmentstatus.length-1 == 0)?<option value="0">Pending</option>:""}
          {(!shipmentstatus[1] || shipmentstatus.length-1 == 1)?<option value="1" >Approved</option>:""}
           {(!shipmentstatus[2]  || shipmentstatus.length-1 == 2)? <option value="2" >In Process</option>:""}
           {(!shipmentstatus[3]  || shipmentstatus.length-1 == 3)? <option value="3" >In Transit</option>:""}
           {(!shipmentstatus[4] || shipmentstatus.length-1 == 4)?<option value="4" >Arrived</option>:""}
           {(!shipmentstatus[5]  || shipmentstatus.length-1 == 5)? <option value="5" >Delivered</option>:""}
           {(!shipmentstatus[6]  || shipmentstatus.length-1 == 6)? <option value="6" >Cancelled</option>:""}
